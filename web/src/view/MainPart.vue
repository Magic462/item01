...
<template>
  <el-row :gutter="6">
    <el-col :lg="3" class="left-col">
      ...
      padding-top: 10px;">
        <li  v-for="(item,index) in leftData" :key="index" class="l-child">{{ item}}</li>
      </ul>
    </el-col>
    <el-col :lg="11" class="mid-col">
